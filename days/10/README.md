...
After 3 seconds, the message appeared briefly: ` _HI_ ` . Of course, your
...
- much longer than the ` _3_ ` seconds in the example above.

Impressed by your sub-hour communication capabilities, the Elves are curious:
_exactly how many seconds would they have needed to wait for that message to
appear?_
